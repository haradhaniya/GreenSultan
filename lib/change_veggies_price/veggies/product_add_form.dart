                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Product will be added to the selected city\'s inventory',
                        style: TextStyle(
                          fontSize: 12,
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(
          children: [
            ...
            const SizedBox(width: 12),
            const Expanded(child: Text('Product uploaded successfully')),
          ],
        ),
        backgroundColor: Colors.green,
        behavior: SnackBarBehavior.floating,
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Row(
          children: [
            const Icon(Icons.error_outline, color: Colors.white),
            const SizedBox(width: 12),
            Expanded(child: Text('Failed to upload product: $error')),
          ],
        ),
        backgroundColor: Colors.red,
        behavior: SnackBarBehavior.floating,
